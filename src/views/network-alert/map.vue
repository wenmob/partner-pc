  ...
  <div style="min-width: 1100px; min-height: 760px">
    ...
    >
      ...
      <bm-control :offset="offset4" anchor="BMAP_ANCHOR_TOP_RIGHT">
        ...
        <div class="right-div-cont">
          ...
          <div class="right-div"  style="margin-top: 15px">
            <span class="s1" style="background: #A6D39C"></span><span class="s2">正常网点：{{rightObj.normalDot}}个</span>
            <div style="clear: both"></div>
          </div>

          <div class="right-div"  style="margin-top: 15px">
            <span class="s1" style="background: #CF5862"></span><span class="s2">车辆爆满网点：{{rightObj.fullCarDot}}个</span>
            <div style="clear: both"></div>
          </div>

          <div class="right-div"  style="margin-top: 15px">
            <span class="s1" style="background: #F8D697"></span><span class="s2">预警网点：{{rightObj.warningDot}}个</span>
            <div style="clear: both"></div>
          </div>

          <div class="right-div"  style="margin-top: 15px">
            <span class="s1" style="background: #B2D3EF"></span><span class="s2">亏电网点：{{rightObj.lossElectricDot}}个</span>
            <div style="clear: both"></div>
          </div>

          <div class="right-div"  style="margin-top: 15px">
            <span class="s1" style="background: #000000"></span><span class="s2">离线网点：{{rightObj.offlineDot}}个</span>
            <div style="clear: both"></div>
          </div>
        </div>
      </bm-control>
          ...
          <div class="map-dialog">
            ...
            >
              ...
              <el-form-item label="备注">
                <el-input v-model="formTn.remark" type="textarea"></el-input>
              </el-form-item>
              <el-form-item>
    ...
    <el-dialog
      ...
      tooltip-effect="dark"> 
        ...
        <el-table-column label="行政区域" prop="sAddress">
        </el-table-column>
        ...
        <el-table-column label="车位数量" prop="totalParkingPlace">
        </el-table-column>
      </el-table>
...
import { getWarningList, getDicts, getCarByDot, selectWorkOrderTypeDicts, getBranchDotsByPage, addWorkOrder} from "@/api/network-alert";
export default {
  data() {
    return {
      form: {
  ...
  methods: {
    // 定时器每3秒刷新一次
    timerFun() {
     this.timeid = window.setInterval(this.getWarningList, 3000);
    },
    // 获取网点预警
    getWarningList() {
    ...
    // 创建工单
    createOrder() {
      addWorkOrder(this.formTn).then(res => {
        this.$message({
          message: '生成成功',
          type: 'success'
        });
